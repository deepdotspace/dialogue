  ...
  return (
    <ToastProvider>
      <DeepSpaceAuthProvider>
        <AuthBoot>
          {/* No global top bar — pages own their own headers. data-testid
              "app-root" is the canonical "app shell mounted" hook for tests. */}
          <div data-testid="app-root" className="h-screen overflow-y-auto bg-background">
